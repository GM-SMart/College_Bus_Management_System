...
<body>
  ...
  <div class="container">
    <div class="title">Pay from Account</div>
    <div class="message">${msg}</div>
    <div class="content">
      <form id="accountpayment" method="post">
        <div class="user-details">
          <div class="input-box">
            <span class="details">Dear ${username},Your Fee is ${fee}</span>
          </div>
          <div class="input-box">
            <span class="details">Your Balance is ${balance}</span>
          </div>
          <div class="check">
          ...
          <div class="button">
            <input type="submit" value="payfee" name="payfee" id="payfee">
          </div>
