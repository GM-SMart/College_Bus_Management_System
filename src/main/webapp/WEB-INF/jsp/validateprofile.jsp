...
form .user-details .input-box{
  ...
  .container .content .category{
   ...
   <a href="studentfachome" style="margin-top:-500px;left: 50px;"><img src="https://i0.wp.com/www.indiaretailing.com/wp-content/uploads/2016/02/Home-Button.png" style="width:50px;height:50px; margin-top: 40px; margin-left: -275px;"></a>
<body>
  <!-- <div >
    <button type="button" class="homebtn" href='mlogin'>Home</button>
  </div> -->
  <div class="container">
    <div class="title">Validate your details</div>
      ...
      <form id="validate" method="post">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" value="${phonenum}" name="phonenum" id="phonenum" required>
          </div>
        ...
        <div class="input-box">
          ...
          <textarea name="address" id="address" name="address" for="address" required>${address}</textarea>
        </div>

        <div class="check">
          <input type="checkbox" required>   I agree to the terms and conditions</input>
        </div>
